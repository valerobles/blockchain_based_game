...
contract NFT is ERC721, ERC721Enumerable {
    ...
    uint256 L2_CONTRACT = 0x1be4d2493c9a55f33cfff813c19e93a74e1f9bdedb06fb53fe30770a6e72cf7; // TODO: change to l2 contract address

    uint256 fightIDCounter = 0;

    uint256 constant SELECTOR =
        352040181584456735608515580760888541466059565068553383579463728554843487745; // TODO
    ...
    constructor() ERC721("NFT","CC") {
        starknetCore = IStarknetCore(address(0)); // TODO
    }
    ...
    function mint(uint256  _name_id) public {
        ...
        _mint(msg.sender, _uuid); // save_mint in openzeppelin?
...
/**
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    uint256 L2_CONTRACT = 0x25c255d886ea903117639a895851f095baee9c2f1a81480fa0cf88e511d0030; // TODO: change to l2 contract address
    ...
    constructor() ERC721("NFT","CC") {
        starknetCore = IStarknetCore(address(0));
    }
...
/**
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    function get_winner(
        ...
        // Consume the message from the StarkNet core contract.
        // This will revert the (Ethereum) transaction if the message does not exist.
        starknetCore.consumeMessageFromL2(l2ContractAddress, payload); // nur ein mal aufrufen? überprüfen ob die es schon gibt
